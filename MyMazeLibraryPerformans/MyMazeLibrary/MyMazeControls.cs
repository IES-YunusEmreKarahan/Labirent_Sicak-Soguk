...
namespace MyMazeLibrary
{
    public class MazeControls
    {
        ...
        public static void Controls(ConsoleKeyInfo key)
        {
            ...
            else if (key.KeyChar == 'p' || key.KeyChar == 'P') // Oyunu Sonlandırmak
            {
                MazeData.newLine = MazeData.exitLine;
                MazeData.newColumn = MazeData.exitColumn;
                PrintMaze();
            }
